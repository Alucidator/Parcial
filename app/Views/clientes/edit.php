...
<form action="<?= base_url('clientes/update/' . $cliente['cliente_id']); ?>" method="post">
    ...
    <input type="date" name="fecha_sucripcion" value="<?= $cliente['fecha_sucripcion']; ?>" required><br>

    <label for="correo_electronico">Correo Electrónico:</label>
    <input type="email" name="correo_electronico" value="<?= $cliente['correo_electronico']; ?>" required><br>

    <label for="telefono_movil">Teléfono Móvil:</label>
    <input type="text" name="telefono_movil" value="<?= $cliente['telefono_movil']; ?>" required><br>
